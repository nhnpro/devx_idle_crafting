...
public class AudioRandomSimpleComponent : MonoBehaviour, IPlayableAudioComponent
{
	...
	private void Update()
	{
		for (int i = 0; i < m_instances.Count; i++)
		{
			...
			if (!audioObject.audioSource.isPlaying && audioObject.audioState != AudioObject.AUDIOSTATE.Paused)
			{
