...
namespace UniRx.Operators
{
	internal class TimestampObservable<T> : OperatorObservableBase<Timestamped<T>>
	{
		...
		public TimestampObservable(UniRx.IObservable<T> source, IScheduler scheduler)
		...
		protected override IDisposable SubscribeCore(UniRx.IObserver<Timestamped<T>> observer, IDisposable cancel)
		{
