...
namespace UniRx
{
	public static class AsyncReactiveCommandExtensions
	{
		...
		public static IDisposable BindToOnClick(this AsyncReactiveCommand<Unit> command, Button button, Func<Unit, UniRx.IObservable<Unit>> asyncOnClick)
		{
			IDisposable disposable = command.CanExecute.SubscribeToInteractable(button);
			IDisposable disposable2 = button.OnClickAsObservable().SubscribeWithState(command, delegate(Unit x, AsyncReactiveCommand<Unit> c)
			{
		...
		public static IDisposable BindToOnClick(this Button button, Func<Unit, UniRx.IObservable<Unit>> asyncOnClick)
		{
			return new AsyncReactiveCommand().BindToOnClick(button, asyncOnClick);
		}

		public static IDisposable BindToOnClick(this Button button, IReactiveProperty<bool> sharedCanExecuteSource, Func<Unit, UniRx.IObservable<Unit>> asyncOnClick)
		{
