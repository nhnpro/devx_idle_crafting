...
namespace UniRx
{
	...
	{
		public static ReactiveCommand ToReactiveCommand(this UniRx.IObservable<bool> canExecuteSource, bool initialValue = true)
		{
			return new ReactiveCommand(canExecuteSource, initialValue);
		}

		public static ReactiveCommand<T> ToReactiveCommand<T>(this UniRx.IObservable<bool> canExecuteSource, bool initialValue = true)
		{
		...
		public static IDisposable BindToButtonOnClick(this UniRx.IObservable<bool> canExecuteSource, Button button, Action<Unit> onClick, bool initialValue = true)
		{
