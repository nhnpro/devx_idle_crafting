Shader "FP/DiffuseUnlitVegetationAmplitude"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          float3 tmpvar_5;
          tmpvar_5 = float3(max(0, sign((-dot(normalize(mul(in_v.normal, tmpvar_4)), _WorldSpaceLightPos0.xyz)))));
          darkside_3 = tmpvar_5;
          float4 tmpvar_6;
          tmpvar_6.w = 1;
          tmpvar_6.xyz = (in_v.vertex + tmpvar_2).xyz.xyz;
          out_v.vertex = mul(unity_MatrixVP, mul(unity_ObjectToWorld, tmpvar_6));
          out_v.xlv_TEXCOORD0 = TRANSFORM_TEX(in_v.texcoord.xy, _MainTex);
          out_v.xlv_COLOR0 = darkside_3;
          return out_v;
      }
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          float4 col_1;
          col_1.w = 1;
          col_1.xyz = (tex2D(_MainTex, in_f.xlv_TEXCOORD0).xyz * max(1, in_f.xlv_COLOR0.x)).xyz;
          out_f.color = col_1;
          return out_f;
      }
