Shader "FP/TransparentUnlitScrollFast"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 2, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          out_v.xlv_TEXCOORD1 = ((in_v.texcoord.xy + (tmpvar_8 * _MainTex_ST.xy)) + _MainTex_ST.zw);
          return out_v;
      }
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          float x_1;
          x_1 = (tex2D(_MainTex, in_f.xlv_TEXCOORD1).w - 2).x;
          if((x_1<0))
          {
              discard;
          }
