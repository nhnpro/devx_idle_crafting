Shader "FP/UI-GrayScale"
{
  Properties
  {
    [PerRendererData] _MainTex ("Sprite Texture", 2D) = "white" {}
    _Color ("Tint", Color) = (1,1,1,1)
    _Saturation ("_Saturation", Range(0, 1)) = 0
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          color_2 = tmpvar_3;
          color_2.xyz = float3(((color_2.xyz * _Saturation) + (dot(color_2.xyz, float3(0.22, 0.707, 0.071)) * (1 - _Saturation))));
          float tmpvar_4;
          float2 tmpvar_5;
