  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          float tmpvar_6;
          tmpvar_6 = max(0, sign(((-dot(worldNormal_1, _WorldSpaceLightPos0.xyz)) + 0.2)));
          tmpvar_3.x = tmpvar_6;
          tmpvar_2.xyz = float3(((in_v.color.xyz * 0.25) + 0.75));
          float4 tmpvar_7;
          tmpvar_7.w = 1;
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          float4 col_1;
          col_1.xyz = (tex2D(_MainTex, in_f.xlv_TEXCOORD0).xyz * min(float4(max(1, in_f.xlv_COLOR1.x)), in_f.xlv_COLOR0).x).xyz;
          col_1.w = 0.5;
          out_f.color = col_1;
          return out_f;
      }
