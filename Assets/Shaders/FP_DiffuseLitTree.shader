  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          float4 tmpvar_2;
          tmpvar_2.xyw = float3(0, 0, 0);
          tmpvar_2.z = ((((sin((_Time.y + (tmpvar_1.z * 0.2))) + sin((_Time.z + (tmpvar_1.z * 0.2)))) * 0.015) * tmpvar_1.y) * (1 + (sin((_Time.y * 0.5)) * 0.5)));
          float4 diffuse_3;
          float3 darkside_4;
          float3x3 tmpvar_5;
          ...
          darkside_4 = tmpvar_9;
          out_v.vertex = mul(unity_MatrixVP, (tmpvar_1 + tmpvar_2));
