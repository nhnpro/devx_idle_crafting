  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          float tmpvar_4;
          tmpvar_4 = dot(normalize(mul(in_v.normal, tmpvar_3)), _WorldSpaceLightPos0.xyz);
          float4 tmpvar_5;
          float4 x_6;
          x_6 = (glstate_lightmodel_ambient * 2);
          tmpvar_5 = lerp(x_6, _LightColor0, float4(clamp(((tmpvar_4 * 2) + 0.5), 0, 1)));
          diffuse_1 = tmpvar_5;
          float3 tmpvar_7;
          tmpvar_7 = float3(max(0, sign((-tmpvar_4))));
          darkside_2 = tmpvar_7;
          float4 tmpvar_8;
          tmpvar_8.w = 1;
          tmpvar_8.xyz = float3(in_v.vertex.xyz);
          out_v.vertex = mul(unity_MatrixVP, mul(unity_ObjectToWorld, tmpvar_8));
          out_v.xlv_TEXCOORD0 = TRANSFORM_TEX(in_v.texcoord.xy, _MainTex);
          out_v.xlv_COLOR0 = diffuse_1;
