...
namespace AppsFlyerSDK
{
    public class AppsFlyer : MonoBehaviour
    {
        ...
        {
            Debug.Log("track App Launch");
        }

        public static void trackRichEvent(string retainedDay, Dictionary<string,string> p1)
        {
            Debug.Log("track Rich Event");
        }

        public static void validateReceipt(string s, string purchaseData, string signature, string toString, string metadataIsoCurrencyCode, Dictionary<string, string> dictionary)
        {
            Debug.Log("validateReceipt");
        }
    }
